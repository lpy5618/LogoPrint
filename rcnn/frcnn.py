...
import rcnn.nets.frcnn as frcnn
from rcnn.utils.anchors import get_anchors
from rcnn.utils.utils import (cvtColor, get_classes, get_new_img_size, resize_image,
                         show_config)
from rcnn.utils.utils_bbox import BBoxUtility
...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : 'rcnn/model_data/best_epoch_weights.h5',
        "classes_path"  : 'rcnn/model_data/voc_classes.txt',
        #---------------------------------------------------------------------#
